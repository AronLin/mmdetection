...
from .base_stuff_head import BaseStuffHead
...
class PanoFpnHead(BaseStuffHead):
    ...
    def __init__(self,
                 ...
                 conv_cfg=None,
                 norm_cfg=None,
                 loss_stuff=dict(type='CrossEntropyLoss', loss_weight=1.0)):
        super(PanoFpnHead, self).__init__(num_classes, num_feats, loss_stuff)
    ...
    def loss(self, logits, gt_semantic_seg):
        ...
        return super(PanoFpnHead, self).loss(logits, gt_semantic_seg)
