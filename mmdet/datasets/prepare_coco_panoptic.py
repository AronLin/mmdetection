...
def separate_coco_semantic_from_panoptic(panoptic_json, panoptic_root,
    ...
    It maps all thing categories to class 0, and maps all unlabeled pixels
    to class 255. It maps all stuff categories to contiguous ids starting
    from 1.
    Args:
...
if __name__ == '__main__':
    dataset_dir = os.path.join('./data', 'coco')
    for s in ['val2017', 'train2017']:
        separate_coco_semantic_from_panoptic(
            ...
            os.path.join(dataset_dir,
                         'annotations/panoptic_stuff_{}'.format(s)),
            COCO_CATEGORIES,
        )
